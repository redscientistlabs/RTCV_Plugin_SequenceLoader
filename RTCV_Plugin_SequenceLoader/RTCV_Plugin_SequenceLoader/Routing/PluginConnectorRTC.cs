...
using SEQUENCELOADER;
using RTCV.CorruptCore;
using RTCV.NetCore;
using System.Windows.Forms;
using SEQUENCELOADER.UI;
using RTCV.Common;
...
namespace SEQUENCELOADER
{
    ...
    {
        SEQUENCELOADER plugin;
        public PluginConnectorRTC(SEQUENCELOADER _plugin)
        {
            plugin = _plugin;
                ...
                case Commands.SHOW_WINDOW:
                    try
                    {
                        SyncObjectSingleton.FormExecute(() =>
                        {
                            ...
                            {
                                SEQUENCELOADER.PluginForm = new PluginForm(plugin);
                                S.SET<PluginForm>(SEQUENCELOADER.PluginForm);
                            }
